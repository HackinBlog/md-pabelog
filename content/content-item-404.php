<article id="content-404" class="has-inline-post-thumbnail" <?php md_article_schema(); ?>>
	...
	<header class="content-item-headline content-item<?php echo md_headline_classes(); ?>"<?php echo md_featured_image_cover(); ?>>
		<div class="<?php echo md_headline_inner_classes(); ?>">
			...
			<h1 class="headline"><?php _e( 'Konten Tidak Ditemukan', 'md' ); ?></h1>
	...
	<div class="content-item-text content-item inner links-main" itemprop="text">
		<div class="<?php md_content_text_classes(); ?> clear">
			...
			<p><?php _e( 'Sepertinya halaman yang kamu cari belum ada atau tidak ditemukan, mungkin halaman yang berhubungan berikut bisa membantu:', 'md' ); ?></p>

			<div class="content-item-404-search mb-double">

				<h4><?php _e( 'Cari lagi', 'md' ); ?></h4>

				<p><?php _e( 'Jika kamu pernah mengunjungi halaman tersebut, coba cari pada form pencarian di bawah dengan kata kunci yang paling tepat.', 'md' ); ?></p>
			...
			<?php
				$instance = array(
					'title' => __( 'Jelajahi Konten Terbaru', 'md' )
				);
				$args = array(
			...
			<?php
				$instance = array(
					'title'    => __( 'Jelajahi Menurut Bulan', 'md' ),
					'dropdown' => 1
				);
				$args = array(
