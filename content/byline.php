...
<div class="byline<?php echo md_byline_classes(); ?>">
	...
	<?php if ( in_array( 'author', $byline ) ) : ?>
		...
		<span class="byline-author byline-item"><i class="md-icon-user byline-item-icon md-icon"></i>

			<em><?php _e( '', 'md' ); ?></em>

			<span class="links-main" itemprop="author" itemscope itemtype="http://schema.org/Person">
		...
		<span class="byline-author byline-item"><i class="md-icon-angle-right byline-item-icon md-icon"></i> <?php the_category( ' ' ); ?></span>
